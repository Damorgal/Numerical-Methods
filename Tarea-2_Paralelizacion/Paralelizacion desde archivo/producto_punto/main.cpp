...
double prod_punto(double* a, double* b, int n);
...
// Funcion que hace el producto punto de los vectores a y b y lo devuelve por la izquierda
double prod_punto(double* a, double* b, int n) {
    double pp=0;
